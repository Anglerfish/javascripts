...
$(document).ready(function(){
  ...
  tempDate.setDate(0);
  $("input#HSend").val((tempDate.getMonth() + 1) + "/" + tempDate.getDate() + "/" + tempDate.getFullYear());
  tempDate.setDate(1);
  $("input#HSstart").val((tempDate.getMonth() + 1) + "/" + tempDate.getDate() + "/" + tempDate.getFullYear());
  
  $("input#HSstart, input#HSend").keydown(function(e){
    if(e.keyCode == 13){
      exeHSCount($("input#HSstart").val(),$("input#HSend").val());
    }
  });
  
  $("input.HSexecute").click(function(){
    exeHSCount($("input#HSstart").val(),$("input#HSend").val());
  });
...
function exeHSCount(vhsstart,vhsend) {  
  hsstart = SPdateConverter(vhsstart);
  hsend = SPdateConverter(vhsend);
